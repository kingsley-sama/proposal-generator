...
const serviceDescriptions = {
  'exterior-ground': {
    ...
    description: [
      {
        text: 'Geliefert werden {{QUANTITY}}x gerenderte Außenansichten des Objektes „{{PROJECT_NAME}}“ aus den folgenden Bodenperspektiven (siehe rote Pfeile):',
        children: []
      },
      { text: 'Fotorealistische Qualität', children: [] },
      { text: 'Auf Wunsch eingefügt in von Ihnen zu liefernde Fotos oder schematische Modellierung der Umgebung', children: [] },
  ...
  'interior': {
    ...
    description: [
      {
        text: 'Geliefert werden {{QUANTITY}}x gerenderte Innenansichten der Räume:',
        children: []
      },
      { text: 'Fotorealistische Qualität', children: [] },
  ...
  '3d-floorplan': {
    ...
    description: [
      { text: 'Geliefert werden {{QUANTITY}}x 3D-Grundrisse des Objektes „{{PROJECT_NAME}}“ folgender Einheiten:', children: [] },
  ...
  '3d-complete-floor': {
    ...
    description: [
      {
        text: 'Geliefert werden {{QUANTITY}}x 3D-Geschosspläne des Objektes „{{PROJECT_NAME}}“ folgender Einheiten:',
        children: []
      },
      { text: 'Hochwertig standardmöbliert', children: [] },
      { text: 'Exklusive Qualität', children: [] },
  ...
  '2d-floorplan': {
    ...
    description: [
      { text: 'Geliefert werden {{QUANTITY}}x 2D-Grundrisse des Objektes „{{PROJECT_NAME}}“ folgender Einheiten:', children: [] },
      { text: 'Hochwertig standardmöbliert', children: [] },
      { text: 'Exklusive Qualität', children: [] },
      { text: 'Inkl. 1 Revisionsrunde⁽¹⁾', children: [] },
      { text: '2.500px x 1.500 px bei 300 DPI', children: [] }
  ...
  'home-staging': {
    ...
    description: [
      {
        text: 'Geliefert werden {{QUANTITY}}x Digital Home Staging Fotos der Räume:',
        children: []
      },
  ...
  'renovation': {
    ...
    description: [
      {
        text: 'Geliefert werden {{QUANTITY}}x Digitale Renovierungsfotos der Räume:',
        children: []
      },
      { text: 'Basiert auf vom Kunden bereitgestellten Fotos', children: [] },
      { text: 'Individuell eingerichtet', children: [] },
  ...
  '360-exterior': {
    ...
    sub_name: '(nur in Kombination mit mind. 2x 3D-Außenvisualisierung)',
  ...
  'slideshow': {
    ...
    link: 'https://www.exposeprofi.de/3d-visualisierungen/architekturvisualisierungen#referenzen-virtueller-videorundgang',
    description: [
      { text: 'Geliefert wird {{QUANTITY}}x Slideshow-Video des Objektes', children: [] },
  ...
  'site-plan': {
    ...
    defaultPrice: 99.00,
    description: [
      { text: 'Geliefert wird {{QUANTITY}}x 3D-Lageplan des Objektes in Draufsicht', children: [] },
      { text: 'Exklusive Qualität', children: [] },
      { text: 'Inkl. 1 Revisionsrunde⁽¹⁾', children: [] }
    ]
  },
  ...
  'expose-layout': {
    ...
    description: [
      { text: 'Geliefert wird {{QUANTITY}}x Exposé Layout für den Vertrieb des Objektes', children: [] },
  ...
  'expose-creation': {
    ...
    description: [
      { text: 'Geliefert wird {{QUANTITY}}x komplettes Exposé für den Vertrieb des Objektes', children: [] },
  ...
  'project-branding': {
    ...
    description: [
      { text: 'Gesamtmarkenkonzept für das Bauvorhaben zur Schaffung einer unverwechselbaren Identität', children: [] },
      { text: 'Entwicklung eines durchgängigen visuellen Auftritts (Logo, Farbwelt, Typografie)', children: [] },
      { text: 'Abgestimmt auf die Zielgruppe, Lage und Architektur des Projekts für maximale Wiedererkennbarkeit', children: [] },
  ...
  'project-website': {
    ...
    description: [
      { text: 'Erstellung einer modernen, responsiven Website zur professionellen und vollständigen Präsentation des Projekts', children: [] },
      { text: 'Individuelles Design, visuell hochwertig, klar strukturiert und zielgruppenorientiert', children: [] },
      { text: 'Gewährleistet eine optimale Darstellung des Projekts in seiner Gesamtheit – von Architektur und Lage bis hin zu Ausstattung und Konzept', children: [] },
      { text: 'Lieferung in vollständig funktionsfähiger, onlinefähiger Ausführung', children: [] },
  ...
  'flat-finder': {
    name: 'Flat Finder',
    description: [
      { text: 'Geliefert wird {{QUANTITY}}x interaktiver Flat Finder als eines der Kernelemente der Projektwebseite', children: [] },
      { text: 'Ermöglicht eine intuitive und ansprechende Erkundung des Gebäudes: Potenzielle Käufer können die Außenansicht des Projekts erkunden und per Klick gezielt einzelne Wohneinheiten auswählen', children: [] },
      { text: 'Detaillierte Apartmentübersicht: Beim Anklicken einer Einheit werden weitere Informationen wie z.B. Grundriss, Innenvisualisierungen und/oder interaktive Tour angezeigt', children: [] },
      { text: 'Bietet eine realistische und umfassende Vorstellung der Wohneinheiten und unterstützt so aktiv den Verkaufsprozess', children: [] },
      { text: 'Vollständig an das Design und Branding der Projektwebsite angepasst', children: [] }
    ]
  },
  'online-marketing': {
    name: 'Online Marketing',
    description: [
      { text: 'Entwicklung und Umsetzung einer zielgerichteten Social-Media-Strategie zur Vermarktung des Projekts', children: [] },
      { text: 'Erstellung hochwertiger Postings und Anzeigen auf Basis der erstellten Visualisierungen und Videos', children: [] },
      { text: 'Planung, Gestaltung und Schaltung von Social-Media-Kampagnen zur Generierung qualifizierter Kaufinteressenten', children: [] },
      { text: 'Durchführung von Zielgruppen- und Marktanalysen zur optimalen Kampagnenausrichtung', children: [] },
      { text: 'Laufende Betreuung und Optimierung der Kampagnen für maximale Performance', children: [] },
